...
public class ChunkProviderPorker implements IChunkProvider
{
private Random rand;
...
for (int k1 = 0; k1 < b1; ++k1)
{
         ...
         if ((d16 += d15) > 0.0D)
         {
                 ...
                 par3ArrayOfByte[j2 += short1] = (byte)PorkerCraft.PorkStone.blockID;//
         }
         else if (k1 * 8 + l1 < b2)
         {
...
for (int var16 = 127; var16 >= 0; var16--)
{
         ...
         /** Main filler block fill's all the underground, replaces block stone **/
         else if (var18 != PorkerCraft.PorkStone.blockID)
         {
         if (var13 == -1)
         {
         if (var12 == 0)
...
int var14 = var5 + this.rand.nextInt(16) + 8;
new WorldGenGlowPig1(Block.glowStone.blockID).generate(this.worldObj, this.rand, var12, var13, var14);
}
