...
public class WorldGenPorkTree extends WorldGenerator implements IWorldGenerator
{
...
public WorldGenPorkTree(boolean par1)
{
this(par1, 8, 0, 0, false);
}
public WorldGenPorkTree(boolean par1, int par2, int par3, int par4, boolean par5)
{
super(par1);
...
/** Custom grass block **/
Block block = PorkerCraft.PorkGrass;
if (k1 != 0 && !block.isLeaves(par1World, l1, i1, j1)

/** Custom grass block **/
&& k1 != PorkerCraft.PorkGrass.blockID
&& k1 != PorkerCraft.PorkStone.blockID
...
/** Custom grass block **/
Block soil = PorkerCraft.PorkGrass;

/** Custom Sapling block **/
boolean isSoil = (soil != null && soil.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockPorkTreeSapling)PorkerCraft.PorkTreeSapling));
...
{
/** Custom leaf block **/
this.setBlockAndMetadata(par1World, j2, j1, l2, PorkerCraft.PorkTreeLeaf.blockID, this.metaLeaves);
}
}
}
}
...
{
/** Custom Log block **/
this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, PorkerCraft.PorkTreeLog.blockID, this.metaWood);
}
}
...
(new WorldGenPorkTree(false, 9, 0, 0, false)).generate(world, random, xCoord, yCoord, zCoord);
}
}
}