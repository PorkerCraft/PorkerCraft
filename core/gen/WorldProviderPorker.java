...
{
this.worldChunkMgr = new WorldChunkManagerHell(PorkerCraft.PorkerLand, this.dimensionId, this.dimensionId);
this.dimensionId = PorkerCraft.dimension;
this.hasNoSky = false;
}
public IChunkProvider createChunkGenerator()
{
return new ChunkProviderPorker(this.worldObj, this.worldObj.getSeed(), false);
}
...
{
	 return this.worldObj.getWorldVec3Pool().getVecFromPool(0, 1, 1);
}*/
...
{
return "/PorkerCraft/Sun.png";
}
@SideOnly(Side.CLIENT)
public String getMoonTexture()
{
return "/PorkerCraft/Moon.png";
}
...
{
if ((this instanceof WorldProviderPorker))
{
return "Entering Porker Land";
}
return null;
}
@SideOnly(Side.CLIENT)
