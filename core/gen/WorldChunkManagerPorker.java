...
public class WorldChunkManagerPorker extends WorldChunkManager
{
...
protected WorldChunkManagerPorker()
{
this.myBiomeCache = new BiomeCache(this);
this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
this.myBiomesToSpawnIn.add(PorkerCraft.PorkerLand);
this.myBiomesToSpawnIn.add(PorkerCraft.PigPlains);
}

public WorldChunkManagerPorker(long seed, WorldType worldtype)
{
this();
// i changed this to my GenLayerTutorial
GenLayer[] agenlayer = GenLayerPorker.makeTheWorld(seed);
this.myGenBiomes = agenlayer[0];
this.myBiomeIndexLayer = agenlayer[1];
}

public WorldChunkManagerPorker(World world)
{
...
par1ArrayOfBiomeGenBase[i] = PorkerCraft.PorkerLand;
}
}
