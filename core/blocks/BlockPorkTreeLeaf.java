...
public class BlockPorkTreeLeaf extends BlockLeavesBase implements IShearable
{
    public static final String[] LEAF_TYPES = new String[] {"porkoak"};
    public static final String[][] field_94396_b = new String[][] {{"leaves_porkoak"}, {"leaves_porkoak_opaque"}};
    @SideOnly(Side.CLIENT)
    private int field_94394_cP;
    private Icon[][] iconArray = new Icon[2][];
    int[] adjacentTreeBlocks;

    public BlockPorkTreeLeaf(int par1)
    {
    ...
    {
        return PorkerCraft.PorkTreeSapling.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(Item.porkRaw, 1, 0));
            }
        }
    }
