...
public class BlockFirePorker extends BlockFire {
	private int[] chanceToEncourageFire = new int[256];
	private int[] abilityToCatchFire = new int[256];
	@SideOnly(Side.CLIENT)
	private Icon[] iconArray;

	public BlockFirePorker(int par1) {
		super(par1);
	...
	public void onBlockAdded(World par1World, int par2, int par3, int par4) {
		...
		if ((par1World.getBlockId(par2, par3 - 1, par4) != PorkerCraft.PorkObsidian.blockID)
				|| (!BlockPorkerPortal.tryToCreatePortal(par1World, par2, par3, par4))) {
			if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4))
					&& (!canNeighborBurn(par1World, par2, par3, par4))) {
				par1World.setBlockToAir(par2, par3, par4);
			} else {
	...
	public void randomDisplayTick(World par1World, int par2, int par3,
		...
		if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4))
				&& (!PorkerCraft.FirePorker.canBlockCatchFire(par1World, par2,
						par3 - 1, par4, ForgeDirection.UP))) {
			if (PorkerCraft.FirePorker.canBlockCatchFire(par1World, par2 - 1,
					par3, par4, ForgeDirection.EAST)) {
				for (int l = 0; l < 2; l++) {
			...
			if (PorkerCraft.FirePorker.canBlockCatchFire(par1World, par2, par3,
			...
			if (PorkerCraft.FirePorker.canBlockCatchFire(par1World, par2,
					par3 + 1, par4, ForgeDirection.DOWN)) {
				for (int l = 0; l < 2; l++) {
					float f = par2 + par5Random.nextFloat();
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.iconArray = new Icon[] {
				par1IconRegister.registerIcon("PorkerCraft:PorkFire_0"),
				par1IconRegister.registerIcon("PorkerCraft:PorkFire_1") };
	}
