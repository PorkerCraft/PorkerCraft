...
public class PorkGrass extends Block
{
    ...
    public PorkGrass(int par1, Material grass)
    {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("PorkerCraft:porkgrass_side");
        this.iconGrassTop = par1IconRegister.registerIcon("PorkerCraft:porkgrass_top");
        this.iconSnowSide = par1IconRegister.registerIcon("porksnow_side");
        this.iconGrassSideOverlay = par1IconRegister.registerIcon("porkgrass_side_overlay");
    }
