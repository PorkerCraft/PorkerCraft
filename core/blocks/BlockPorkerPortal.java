...
import PorkerCraft.core.util.TeleporterPorker;
...
public class BlockPorkerPortal extends BlockBreakable
{
public BlockPorkerPortal(int par1)
{
super(par1, "ProkerCraft:PorkerPortal", Material.portal, false);
...
for (i1 = -1; i1 <= 3; ++i1)
{
         ...
         else if (j1 != 0 && j1 != PorkerCraft.FirePorker.blockID)
         {
         return false;
         }
         }
...
for (i1 = 0; i1 < 3; ++i1)
{
         par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, PorkerCraft.PorkerPortal.blockID, 0, 2);
}
}
return true;
}
...
if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
         ...
         else if (thePlayer.dimension != PorkerCraft.dimension)
         {
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, PorkerCraft.dimension, new TeleporterPorker(thePlayer.mcServer.worldServerForDimension(PorkerCraft.dimension)));
         }
         else {
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterPorker(thePlayer.mcServer.worldServerForDimension(0)));
         }
         }
}
@SideOnly(Side.CLIENT)
...
public void registerIcons(IconRegister iconreg){
	this.blockIcon = iconreg.registerIcon("PorkerCraft:PorkerPortal");
}
}