...
public class EntityAIMatePorkerFlying extends EntityAIBase
{
    private EntityPorkerMobFlying theAnimal;
    World theWorld;
    private EntityPorkerMobFlying targetMate;
    ...
    public EntityAIMatePorkerFlying(EntityPorkerMobFlying entityPorkerMobFlying, float par2)
    {
        this.theAnimal = entityPorkerMobFlying;
        this.theWorld = entityPorkerMobFlying.worldObj;
        this.moveSpeed = par2;
        this.setMutexBits(3);
    }
     ...
     * valid mate found.
     */
    private EntityPorkerMobFlying getNearbyMate()
    {
        float f = 8.0F;
        ...
        EntityPorkerMobFlying entityanimal = null;
        Iterator iterator = list.iterator();

        while (iterator.hasNext())
        {
            EntityPorkerMobFlying entityanimal1 = (EntityPorkerMobFlying)iterator.next();
