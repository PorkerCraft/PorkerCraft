...
public class EntityAIFollowGolemPorker extends EntityAIBase
{
    private EntityPigMen theVillager;
    private EntityIronGolem theGolem;
    private int takeGolemRoseTick;
    private boolean tookGolemRose = false;

    public EntityAIFollowGolemPorker(EntityPigMen par1EntityPigMen)
    {
        this.theVillager = par1EntityPigMen;
        this.setMutexBits(3);
    }
