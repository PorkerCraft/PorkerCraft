...
public class EntityAIMatePorker extends EntityAIBase
{
    private EntityPorkerMob theAnimal;
    World theWorld;
    private EntityPorkerMob targetMate;
    ...
    public EntityAIMatePorker(EntityPorkerMob entityPorkerMob, float par2)
    {
        this.theAnimal = entityPorkerMob;
        this.theWorld = entityPorkerMob.worldObj;
        this.moveSpeed = par2;
        this.setMutexBits(3);
    }
     ...
     * valid mate found.
     */
    private EntityPorkerMob getNearbyMate()
    {
        float f = 8.0F;
        ...
        EntityPorkerMob entityanimal = null;
        Iterator iterator = list.iterator();

        while (iterator.hasNext())
        {
            EntityPorkerMob entityanimal1 = (EntityPorkerMob)iterator.next();
