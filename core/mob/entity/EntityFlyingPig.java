...
public class EntityFlyingPig extends EntityPorkerMobFlying {
     ...
     * Plays step sound at given x, y, z for the entity
     */
    protected void playStepSoundPorker(int par1, int par2, int par3, int par4)
    {
        this.playSound("mob.pig.step", 0.15F, 1.0F);
    }
     ...
     */
    public EntityFlyingPig spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new EntityFlyingPig(this.worldObj);
    }
