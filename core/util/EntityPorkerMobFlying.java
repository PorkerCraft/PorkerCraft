...
public abstract class EntityPorkerMobFlying extends EntityAgeable implements IAnimals
{
    public int inLove;
    ...
    public EntityPorkerMobFlying(World par1World)
    {
        super(par1World);
    }
    ...
    protected void attackEntity(Entity par1Entity, float par2)
    {
        ...
        else if (par1Entity instanceof EntityPorkerMobFlying)
        {
            EntityPorkerMobFlying entityanimal = (EntityPorkerMobFlying)par1Entity;
            ...
            else if (this.inLove > 0 && entityanimal.inLove > 0)
            {
                ...
                if (entityanimal.entityToAttack == this && (double)par2 < 3.5D)
                {
                    ...
                    if (this.breeding == 60)
                    {
                        this.procreate((EntityPorkerMobFlying)par1Entity);
                    }
                }
                else
                {
     ...
     * particles.
     */
    private void procreate(EntityPorkerMobFlying par1EntityAnimal)
    {
    ...
    protected Entity findPlayerToAttack()
    {
        ...
        else
        {
            ...
            List list;
            int i;
            EntityPorkerMobFlying entityanimal;
            ...
            if (this.inLove > 0)
            {
                ...
                {
                    entityanimal = (EntityPorkerMobFlying)list.get(i);
     ...
     */
    public boolean canMateWith(EntityPorkerMobFlying par1EntityAnimal)
    {
