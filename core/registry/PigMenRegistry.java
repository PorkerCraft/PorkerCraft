...
package PorkerCraft.core.registry;
...
public class PigMenRegistry
{
     ...
     * @param random
     */
    public static void manageVillagerTrades(MerchantRecipeList recipeList, EntityPigMen entityPigMen, int villagerType, Random random)
    {
        for (IVillageTradeHandler handler : instance().tradeHandlers.get(villagerType))
        {
            handler.manipulateTradesForVillager(entityPigMen, recipeList, random);
        }
    }
