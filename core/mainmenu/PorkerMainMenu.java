...
public class PorkerMainMenu extends MenuBase
{
    ...
    private GuiPorkerButton buttonResetDemo;
    ...
    private GuiPorkerButton fmlModButton = null;

    public PorkerMainMenu()
    {
    ...
    public void initGui()
    {
        ...
        fmlModButton = new GuiPorkerButton(6, this.width / 2 - 100, i + 48, "Mods");
        ...
        {
            this.buttonList.add(new GuiPorkerButton(0, this.width / 2 - 100, i + 72, stringtranslate.translateKey("menu.options")));
        }
        else
        {
            this.buttonList.add(new GuiPorkerButton(0, this.width / 2 - 100, i + 72 + 12, 98, 20, stringtranslate.translateKey("menu.options")));
            this.buttonList.add(new GuiPorkerButton(4, this.width / 2 + 2, i + 72 + 12, 98, 20, stringtranslate.translateKey("menu.quit")));
        }
        ...
        this.field_92021_u = ((GuiPorkerButton)this.buttonList.get(0)).yPosition - 24;
    ...
    private void func_98060_b(StringTranslate par1StringTranslate, int par2, int par3)
    {
        ...
        GuiPorkerButton realmButton = new GuiPorkerButton(3, this.width / 2 - 100, par2 + par3 * 2, par1StringTranslate.translateKey("menu.online"));
    ...
    {
        this.buttonList.add(new GuiPorkerButton(1, this.width / 2 - 100, par1, par3StringTranslate.translateKey("menu.singleplayer")));
        this.buttonList.add(new GuiPorkerButton(2, this.width / 2 - 100, par1 + par2 * 1, par3StringTranslate.translateKey("menu.multiplayer")));
    }
    ...
    {
        this.buttonList.add(new GuiPorkerButton(11, this.width / 2 - 100, par1, par3StringTranslate.translateKey("menu.playdemo")));
        this.buttonList.add(this.buttonResetDemo = new GuiPorkerButton(12, this.width / 2 - 100, par1 + par2 * 1, par3StringTranslate.translateKey("menu.resetdemo")));
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if (this.field_92025_p != null && this.field_92025_p.length() > 0)
        {
            ...
            this.drawString(this.fontRenderer, field_96138_a, (this.width - this.field_92024_r) / 2, ((GuiPorkerButton)this.buttonList.get(0)).yPosition - 12, 16777215);
        }
    ...
    protected void mouseClicked(int par1, int par2, int par3)
    {
        ...
        {
            GuiConfirmOpenLink guiconfirmopenlink = new GuiConfirmOpenLink(this, "http://tinyurl.com/javappc", 13, field_96141_q);
            guiconfirmopenlink.func_92026_h();
            this.mc.displayGuiScreen(guiconfirmopenlink);
        }
    }

    static Minecraft func_98058_a(PorkerMainMenu field_98132_d)
    {
        return field_98132_d.mc;
    }

    static void func_98061_a(PorkerMainMenu par0GuiMainMenu, StringTranslate par1StringTranslate, int par2, int par3)
    {
