...
public class ComponentVillagePathGenPorker extends ComponentVillageRoadPiecePorker
{
    private int averageGroundLevel;

    public ComponentVillagePathGenPorker(ComponentVillageStartPiecePorker par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
