...
public class ComponentVillageFieldPorker extends ComponentVillagePorker
{
    ...
    public ComponentVillageFieldPorker(ComponentVillageStartPiecePorker par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
