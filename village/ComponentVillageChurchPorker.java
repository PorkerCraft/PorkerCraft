...
public class ComponentVillageChurchPorker extends ComponentVillagePorker
{
    private int averageGroundLevel = -1;

    public ComponentVillageChurchPorker(ComponentVillageStartPiecePorker par0ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
        super(par0ComponentVillageStartPiece, par2);
     ...
     */
    public boolean addComponentPartsPorker(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
