...
public class VillagePorker
{
    ...
    public VillagePorker() {}

    public VillagePorker(World par1World)
    {
    ...
    {
        List list = this.worldObj.getEntitiesWithinAABB(EntityPigMen.class, AxisAlignedBB.getAABBPool().getAABB((double)(this.center.posX - this.villageRadius), (double)(this.center.posY - 4), (double)(this.center.posZ - this.villageRadius), (double)(this.center.posX + this.villageRadius), (double)(this.center.posY + 4), (double)(this.center.posZ + this.villageRadius)));
