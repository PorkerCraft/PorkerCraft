...
public abstract class ComponentVillagePorker extends StructureComponent
{
    ...
    protected ComponentVillageStartPiecePorker startPiece;

    protected ComponentVillagePorker(ComponentVillageStartPiecePorker par0ComponentVillageStartPiece, int par2)
    {
        super(par2);
        this.startPiece = par0ComponentVillageStartPiece;
    }
    ...
    protected StructureComponent getNextComponentNN(ComponentVillageStartPiecePorker par1StructureComponent, List par2List, Random par3Random, int par4, int par5)
    {
        ...
        {
            case 0:
                return StructureVillagePiecesPorker.getNextStructureComponentPorker(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY + par4, this.boundingBox.minZ + par5, 1, this.getComponentType());
            case 1:
                return StructureVillagePiecesPorker.getNextStructureComponentPorker(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + par5, this.boundingBox.minY + par4, this.boundingBox.minZ - 1, 2, this.getComponentType());
            case 2:
                return StructureVillagePiecesPorker.getNextStructureComponentPorker(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY + par4, this.boundingBox.minZ + par5, 1, this.getComponentType());
            case 3:
                return StructureVillagePiecesPorker.getNextStructureComponentPorker(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + par5, this.boundingBox.minY + par4, this.boundingBox.minZ - 1, 2, this.getComponentType());
    ...
    protected StructureComponent getNextComponentPP(ComponentVillageStartPiecePorker par1StructureComponent, List par2List, Random par3Random, int par4, int par5)
    {
        ...
        {
            case 0:
                return StructureVillagePiecesPorker.getNextStructureComponentPorker(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY + par4, this.boundingBox.minZ + par5, 3, this.getComponentType());
            case 1:
                return StructureVillagePiecesPorker.getNextStructureComponentPorker(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + par5, this.boundingBox.minY + par4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
            case 2:
                return StructureVillagePiecesPorker.getNextStructureComponentPorker(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY + par4, this.boundingBox.minZ + par5, 3, this.getComponentType());
            case 3:
                return StructureVillagePiecesPorker.getNextStructureComponentPorker(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + par5, this.boundingBox.minY + par4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
