...
public class ComponentVillageHouse2Porker extends ComponentVillagePorker
{
    ...
    public ComponentVillageHouse2Porker(ComponentVillageStartPiecePorker par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
