...
public class ComponentVillageTorchPorker extends ComponentVillagePorker
{
    ...
    public ComponentVillageTorchPorker(ComponentVillageStartPiecePorker par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
