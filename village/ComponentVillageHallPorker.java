...
public class ComponentVillageHallPorker extends ComponentVillagePorker
{
    ...
    public static ComponentVillageHallPorker func_74906_a(ComponentVillageStartPiecePorker par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new ComponentVillageHallPorker(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
    }
