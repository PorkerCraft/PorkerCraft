...
public class ComponentVillageHouse3Porker extends ComponentVillagePorker
{
    private int averageGroundLevel = -1;

    public ComponentVillageHouse3Porker(ComponentVillageStartPiecePorker par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static ComponentVillageHouse3Porker func_74921_a(ComponentVillageStartPiecePorker par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        return canVillageGoDeeper(structureboundingbox) && StructureComponentPorker.findIntersecting(par1List, structureboundingbox) == null ? new ComponentVillageHouse3Porker(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
    }
