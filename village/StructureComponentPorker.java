...
public abstract class StructureComponentPorker
{
    ...
    protected StructureComponentPorker(int par1)
    {
     ...
     */
    public static StructureComponentPorker findIntersecting(List par0List, StructureBoundingBox par1StructureBoundingBox)
    {
        Iterator iterator = par0List.iterator();
        StructureComponentPorker structurecomponent;
        ...
        do
        {
            ...
            structurecomponent = (StructureComponentPorker)iterator.next();
        }
