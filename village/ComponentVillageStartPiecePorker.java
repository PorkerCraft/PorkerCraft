...
public class ComponentVillageStartPiecePorker extends ComponentVillageWellPorker
{
    ...
    public ComponentVillageStartPiecePorker(WorldChunkManager par1WorldChunkManager, int par2, Random par3Random, int par4, int par5, ArrayList par6ArrayList, int par7)
    {
        super((ComponentVillageStartPiecePorker)null, 0, par3Random, par4, par5);
        ...
        this.biome = PorkerCraft.PorkerLand;
